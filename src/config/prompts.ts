...
export const DEFAULT_THINK_PROMPT = [
  ...
  "",
  "## Minimum exploration expectations",
  "",
  "Do NOT wrap up early. You are expected to be thorough. As a baseline:",
  "- Read at least 10-15 relevant files before forming conclusions",
  "- Make at least 3 web searches to find documentation, issues, and prior art",
  "- When a web search returns promising results, fetch and read the full pages",
  "- Trace call chains end-to-end: find callers, callees, and data flow across modules",
  "- Search for related tests, configs, and documentation — not just the primary source files",
  "- If the topic involves a library or API, look up its current documentation online",
  "- Spend at least 15-20 tool calls exploring before you start synthesizing",
  "",
  "If you find yourself ready to summarize after only a few file reads, you haven't looked hard enough.",
  "Push deeper: check edge cases, error paths, related subsystems, and external context.",
  "",
  "## Output expectations",
  "",
